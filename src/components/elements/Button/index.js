...
const Button = forwardRef(({ children, className, type = 'button', loading = false, outline = false, rounded = false, ...rest }, ref) => {
  return (
    <button
      type={type}
      className={clsx(
        ...
        'py-1.5 px-3 text-sm font-medium text-center inline-flex items-center disabled:cursor-not-allowed',
        className
      )}
      {...rest}
      ref={ref}
