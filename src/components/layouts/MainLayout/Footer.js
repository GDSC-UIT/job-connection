  ...
  return (
    <>
      <div className="bg-gray-100">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 text-gray-800 flex flex-wrap">
          <div className="p-5 w-48">
            <div className="text-xs uppercase text-gray-500  font-medium">Home</div>
            <a className="my-3 block hover:text-emerald-500" href="#">
              Find a Job <span className="text-teal-600 text-xs p-1"></span>
            </a>
            <a className="my-3 block hover:text-emerald-500" href="#">
              Find Talends <span className="text-teal-600 text-xs p-1"></span>
            </a>
            <a className="my-3 block hover:text-emerald-500" href="#">
